...
function createColoredMarker(backgroundColor: string, iconClass: string) {
  ...
  width: 32px;
  height: 44px;
  filter: drop-shadow(0 2px 8px rgba(60,60,60,0.18));
">
...
// List Fakultas di UI
const faculties = [
  { name: 'Kucing', coords: [-6.3680750, 106.83050], type: 'cat', description: 'Uiiauuiiiiai.' },
...
const typeStyles = {
  gedung: { color: '#FFB300', icon: 'ri-building-4-fill' }, // Vibrant yellow
  masjid: { color: '#009688', icon: 'ri-home-heart-fill' }, // Teal
  ruang: { color: '#FFB300', icon: 'ri-door-fill' }, // Vibrant yellow
  money: { color: '#1976D2', icon: 'ri-bank-fill' }, // Strong blue
  bus: { color: '#1976D2', icon: 'ri-bus-fill' }, // Strong blue
  station: { color: '#512DA8', icon: 'ri-train-line' }, // Deep purple
  motorcycle: { color: '#1976D2', icon: 'ri-motorbike-line' }, // Strong blue
  motorcycle_parking: { color: '#1976D2', icon: 'ri-motorbike-line' }, // Strong blue
  hospital: { color: '#E53935', icon: 'ri-hospital-line' }, // Vivid red
  food: { color: '#43A047', icon: 'ri-restaurant-2-line' }, // Green
  university: { color: '#FFB300', icon: 'ri-school-fill' }, // Vibrant yellow
  tempat: { color: '#757575', icon: 'ri-map-pin-fill' }, // Medium gray
  food_court: { color: '#8E24AA', icon: 'ri-restaurant-fill' }, // Green
  restaurant: { color: '#8E24AA', icon: 'ri-restaurant-line' }, // Green
  office: { color: '#607D8B', icon: 'ri-building-line' }, // Blue gray
  bus_station: { color: '#512DA8', icon: 'ri-bus-2-line' }, // Deep purple
  community_centre: { color: '#009688', icon: 'ri-community-line' }, // Teal
  bank: { color: '#1976D2', icon: 'ri-bank-fill' }, // Strong blue
  theatre: { color: '#8E24AA', icon: 'ri-movie-2-fill' }, // Purple
  pitch: { color: '#43A047', icon: 'ri-football-fill' }, // Green
  library: { color: '#512DA8', icon: 'ri-book-3-fill' }, // Deep purple
  parking: { color: '#607D8B', icon: 'ri-parking-box-fill' }, // Blue gray
  place_of_worship: { color: '#009688', icon: 'ri-home-heart-fill' }, // Teal
  sports_complex: { color: '#43A047', icon: 'ri-run-line' }, // Green
  park: { color: '#43A047', icon: 'ri-tree-fill' }, // Green
  accommodation: { color: '#8E24AA', icon: 'ri-hotel-fill' }, // Purple
  entrance: { color: '#1976D2', icon: 'ri-door-open-fill' }, // Strong blue
  cat: { color: '#FFB300', icon: 'ri-gitlab-fill' }, // Vibrant yellow
}

const defaultStyle = { color: '#757575', icon: 'ri-map-pin-fill' }
