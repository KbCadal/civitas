...
import ComposeDialog from '@/views/dstipro/email/ComposeDialog.vue'
import EmailLeftSidebarContent from '@/views/dstipro/email/EmailLeftSidebarContent.vue'
import EmailView from '@/views/dstipro/email/EmailView.vue'
import type { MoveEmailToAction } from '@/views/dstipro/email/useEmail'
import { useEmail } from '@/views/dstipro/email/useEmail'
import type { Email, EmailLabel } from '@db/dstipro/email/types'
...
// Composables
const route = useRoute<'dstipro-email-filter' | 'dstipro-email-label'>()
...
// Fetch Emails
const { data: emailData, execute: fetchEmails } = await useApi<any>(createUrl('/dstipro/email', {
  query: {
    q,
