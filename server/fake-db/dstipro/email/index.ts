  ...
  emails: [
    {
      ...
      from: {
        email: 'sistem.akun@ui.ac.id',
        name: 'Sistem Admin Akun UI',
        avatar: avatar1,
      },
      subject: 'Permintaan Atur Ulang Sandi.',
      cc: [],
      bcc: [],
      message:
        '<p>Hallo!</p><p>Anda menerima email ini karena kami menerima permintaan atur ulang sandi dari akun anda.</p><p><a style="box-sizing: border-box; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #2d3748; border-bottom: 8px solid #2d3748; border-left: 18px solid #2d3748; border-right: 18px solid #2d3748; border-top: 8px solid #2d3748;" href="/reset-pass" target="_blank" rel="noopener">Reset Password</a></p><p>Pengaturan ulang sandi ini akan&nbsp;kadaluarsa dalam 30 menit.</p><p>Jika Anda tidak meminta pengaturan ulang kata sandi, maka tidak diperlukan tindakan lebih lanjut.</p><p>&nbsp;</p><p>Salam,</p><p>Sistem Admin Akun UI</p>',
      attachments: [],
      isStarred: true,
      labels: ['private', 'company', 'important'],
      time: '2024-12-30T12:42:22',
      replies: [],
      folder: 'inbox',
      isRead: false,
      isDeleted: false,
