...
export const staticPrimaryColor = '#ffde01'
export const staticPrimaryDarkenColor = '#FCCF01'

// determine a readable "on-primary" color (white or dark) based on primary color
...
export function getOnPrimary(hex: string) {
  try {
    ...
    // if primary is light, return a dark on-primary; otherwise return white
    return luminance > 0.8 ? '#2E263DE6' : '#ffffff'
  }
  catch (e) {
    return '#ffffff'
  }
...
export const themes: Record<string, ThemeDefinition> = {
  light: {
    ...
    colors: {
      ...
      // choose readable text/icon color for primary dynamically
      'on-primary': getOnPrimary(staticPrimaryColor),
